                ...
                if (!chr  || // end of content
                    ...
                    if (token) {
                        ...
                        el[appendChild](
                            ...
                            '',
                            // 1: keywords
                            'color:var(--accent);font-weight:600;text-shadow:0 0 6px rgba(47, 111, 98, 0.22);',
                            //
                            // 2: punctuation
                            'color:rgba(43, 42, 40, 0.55);',
                            // 3: strings and regexps
                            'color:var(--accent-berry);text-shadow:0 0 6px rgba(122, 75, 107, 0.18);',
                            // 4: comments
                            'font-style:italic;color:rgba(96, 92, 86, 0.7);'
                        ][
                            // not formatted
                            !tokenType ? 0 :
                            // punctuation
