javascript:(function quickSketchBookmarklet() {
  ...
  function createQuickSketchApp(host, shadow) {
    const CONFIG = {
      ...
      toolbarHeight: 116,
      minimumShapeSize: 2,
      highlighterAlpha: 0.34,
      highlighterMinWidth: 10,
      highlighterWidthMultiplier: 5,
      calloutScale: 1.8,
      calloutGap: 24,
      calloutMaxSide: 420,
      minViewScale: 0.5,
      ...
      <style>
        ...
        *, *::before, *::after {
        ...
        .qs-panel {
          ...
          top: var(--qs-top, 16px);
          width: var(--qs-width, ${CONFIG.defaultPanelWidth}px);
          height: var(--qs-height, ${CONFIG.defaultPanelHeight}px);
        ...
        .qs-color-button::after,
        .qs-shape-button::after,
        .qs-stamp-button::after {
          content: "";
          position: absolute;
          right: 4px;
          bottom: 4px;
        ...
        .qs-stamp-button-label {
          ...
          justify-content: center;
          border-radius: 999px;
          background: var(--qs-stamp-badge-bg, #111827);
          color: #ffffff;
          font-size: 11px;
          font-weight: 800;
          line-height: 1;
        ...
        .qs-stamp-button.is-active .qs-stamp-button-label {
          --qs-stamp-badge-bg: #2563eb;
        }
        ...
        .qs-stamp-menu {
          position: absolute;
          top: var(--qs-menu-top, 44px);
          left: var(--qs-menu-left, 8px);
          transform: none;
          z-index: 30;
          padding: 7px;
          border-radius: 12px;
        ...
        .qs-stamp-option:hover {
          background: rgba(15, 23, 42, 0.07);
        }

        .qs-shape-option.is-selected,
        .qs-stamp-option.is-selected {
          color: #2563eb;
        ...
        .qs-selection-action:hover {
          background: rgba(37, 99, 235, 0.13);
          color: #1d4ed8;
        }

        .qs-selection-action:focus-visible {
          outline: 2px solid #2563eb;
          outline-offset: 2px;
        }
      ...
      <section id="qsPanel" class="qs-panel" role="region" aria-label="Quick Sketch floating utility" tabindex="-1">
        <div id="qsToolbar" class="qs-toolbar">
          <div class="qs-toolbar-top">
            <div id="qsDragZone" class="qs-drag-zone" title="Drag Sketch window">
              ...
              <span id="qsTitle" class="qs-title">Quick Sketch</span>
            </div>

            <div class="qs-window-actions" role="toolbar" aria-label="Window actions">
              <button id="qsHelpButton" class="qs-button qs-icon-button" type="button" title="Help and shortcuts" aria-label="Help and shortcuts" aria-expanded="false">${svgIcon("help")}</button>
          ...
          <div class="qs-tool-group" role="toolbar" aria-label="Sketch tools">
            ...
            <button id="qsHighlighterButton" class="qs-button qs-icon-button qs-tool-button" type="button" title="Highlighter" aria-label="Highlighter" aria-pressed="false">${svgIcon("highlighter")}</button>
            ...
            <div id="qsStampWrap" class="qs-stamp-wrap">
              <button id="qsStampButton" class="qs-button qs-stamp-button qs-tool-button" type="button" title="Stamp: Number 1" aria-label="Stamp tool: Number 1" aria-haspopup="menu" aria-expanded="false" aria-pressed="false"><span class="qs-stamp-button-label">1</span></button>
              <div id="qsStampMenu" class="qs-stamp-menu" role="menu" hidden>
                <button class="qs-stamp-option is-selected" type="button" data-stamp="number" role="menuitem">${svgIcon("stampNumber")}<span>Numbered badge</span></button>
                <button class="qs-stamp-option" type="button" data-stamp="check" role="menuitem">${svgIcon("stampCheck")}<span>Check</span></button>
                <button class="qs-stamp-option" type="button" data-stamp="cross" role="menuitem">${svgIcon("stampCross")}<span>Cross</span></button>
                <button class="qs-stamp-option" type="button" data-stamp="warning" role="menuitem">${svgIcon("stampWarning")}<span>Warning</span></button>
              </div>
            </div>
            ...
            <select id="qsZoomSelect" class="qs-select qs-zoom-select" title="View zoom" aria-label="View zoom">
          ...
          <div class="qs-tool-group" role="toolbar" aria-label="History">
            ...
            <button id="qsClearButton" class="qs-button qs-icon-button" type="button" title="Clear annotations" aria-label="Clear annotations" disabled>${svgIcon("clear")}</button>
          </div>
          ...
          <div class="qs-tool-group" role="toolbar" aria-label="Import and export">
            ...
            <button id="qsCropButton" class="qs-button qs-icon-button" type="button" title="Crop to selection" aria-label="Crop to selection" disabled>${svgIcon("crop")}</button>
            <button id="qsCalloutButton" class="qs-button qs-icon-button" type="button" title="Create zoom callout from selection" aria-label="Create zoom callout from selection" disabled>${svgIcon("callout")}</button>
            <button id="qsSpotlightButton" class="qs-button qs-icon-button" type="button" title="Spotlight selection" aria-label="Spotlight selection" disabled>${svgIcon("spotlight")}</button>
        ...
        <div id="qsViewport" class="qs-viewport">
          <div id="qsSurface" class="qs-surface">
            ...
            <div id="qsSelectionActions" class="qs-selection-actions" aria-label="Selection actions" hidden>
              <button id="qsSelectionCopyButton" class="qs-selection-action" type="button">Copy</button>
              <button id="qsSelectionCutButton" class="qs-selection-action" type="button">Cut</button>
              <button id="qsSelectionCropButton" class="qs-selection-action" type="button">Crop</button>
              <button id="qsSelectionCalloutButton" class="qs-selection-action" type="button">Callout</button>
              <button id="qsSelectionSpotlightButton" class="qs-selection-action" type="button">Spot</button>
              <button id="qsSelectionDownloadButton" class="qs-selection-action" type="button">DL</button>
            </div>
          </div>
        </div>
        ...
        <div id="qsHelpOverlay" class="qs-help-overlay" hidden>
          <div class="qs-help-card" role="dialog" aria-modal="false" aria-labelledby="qsHelpTitle">
            <div class="qs-help-header">
              <h2 id="qsHelpTitle" class="qs-help-title">Quick Sketch shortcuts</h2>
              <button id="qsHelpCloseButton" class="qs-button qs-icon-button" type="button" title="Close help" aria-label="Close help">${svgIcon("close")}</button>
            </div>
            <div class="qs-help-body">
              <div class="qs-help-grid">
                <kbd>P</kbd><span>Pen</span>
                <kbd>H</kbd><span>Highlighter</span>
                <kbd>E</kbd><span>Eraser</span>
                <kbd>S</kbd><span>Rectangle selection</span>
                <kbd>T</kbd><span>Text</span>
                <kbd>N</kbd><span>Stamp</span>
                <kbd>Stamp</kbd><span>Click to place numbered or symbolic markers</span>
                <kbd>?</kbd><span>Toggle this help</span>
                <kbd>Esc</kbd><span>Close help, cancel selection, or close panel</span>
                <kbd>Del</kbd><span>Delete selected region</span>
                <kbd>Ctrl Z</kbd><span>Undo</span>
                <kbd>Ctrl Y</kbd><span>Redo</span>
                <kbd>Ctrl C</kbd><span>Copy selection when selected</span>
                <kbd>Ctrl X</kbd><span>Cut selection when selected</span>
                <kbd>Callout</kbd><span>Magnify the selected region into an inset</span>
                <kbd>Spotlight</kbd><span>Dim everything outside the selection</span>
                <kbd>Action bar</kbd><span>Use selection actions beside the selected area</span>
                <kbd>Zoom</kbd><span>Scale the view without changing export size</span>
              </div>
              <p class="qs-help-note">Clipboard actions may be blocked by the browser. Download remains available as the reliable fallback.</p>
            </div>
          </div>
        </div>
    ...
    const els = {
      ...
      selectionActions: shadow.getElementById("qsSelectionActions"),
      selectionCopyButton: shadow.getElementById("qsSelectionCopyButton"),
      selectionCutButton: shadow.getElementById("qsSelectionCutButton"),
      selectionCropButton: shadow.getElementById("qsSelectionCropButton"),
      selectionCalloutButton: shadow.getElementById("qsSelectionCalloutButton"),
      selectionSpotlightButton: shadow.getElementById("qsSelectionSpotlightButton"),
      selectionDownloadButton: shadow.getElementById("qsSelectionDownloadButton"),
      resizeHandle: shadow.getElementById("qsResizeHandle"),
      penButton: shadow.getElementById("qsPenButton"),
      highlighterButton: shadow.getElementById("qsHighlighterButton"),
      ...
      stampWrap: shadow.getElementById("qsStampWrap"),
      stampButton: shadow.getElementById("qsStampButton"),
      stampMenu: shadow.getElementById("qsStampMenu"),
      ...
      zoomSelect: shadow.getElementById("qsZoomSelect"),
      undoButton: shadow.getElementById("qsUndoButton"),
      redoButton: shadow.getElementById("qsRedoButton"),
      clearButton: shadow.getElementById("qsClearButton"),
      imageButton: shadow.getElementById("qsImageButton"),
      cutButton: shadow.getElementById("qsCutButton"),
      cropButton: shadow.getElementById("qsCropButton"),
      calloutButton: shadow.getElementById("qsCalloutButton"),
      spotlightButton: shadow.getElementById("qsSpotlightButton"),
      copyButton: shadow.getElementById("qsCopyButton"),
      downloadButton: shadow.getElementById("qsDownloadButton"),
      helpButton: shadow.getElementById("qsHelpButton"),
      helpOverlay: shadow.getElementById("qsHelpOverlay"),
      helpCloseButton: shadow.getElementById("qsHelpCloseButton"),
    ...
    function wireEvents() {
      ...
      on(els.highlighterButton, "click", function activateHighlighter() {
      ...
      on(els.stampButton, "click", toggleStampMenu);
      on(els.stampMenu, "click", handleStampMenuClick);
      ...
      on(els.zoomSelect, "change", handleZoomChange);
      ...
      on(els.clearButton, "click", clearAnnotations);
      on(els.imageButton, "click", handlePasteImportClick);
      on(els.cutButton, "click", cutSelectedRegion);
      on(els.cropButton, "click", cropSelectedRegion);
      on(els.calloutButton, "click", createSelectionCallout);
      on(els.spotlightButton, "click", createSelectionSpotlight);
      on(els.copyButton, "click", copyPngToClipboard);
      on(els.downloadButton, "click", downloadPng);
      on(els.helpButton, "click", toggleHelpOverlay);
      on(els.helpCloseButton, "click", hideHelpOverlay);
      on(els.helpOverlay, "click", handleHelpOverlayClick);
      ...
      on(els.selectionActions, "pointerdown", stopHostPropagation);
      on(els.selectionActions, "click", stopHostPropagation);
      on(els.selectionCopyButton, "click", function copyFromSelectionBar() {
        copySelectedRegion();
      });
      on(els.selectionCutButton, "click", cutSelectedRegion);
      on(els.selectionCropButton, "click", cropSelectedRegion);
      on(els.selectionCalloutButton, "click", createSelectionCallout);
      on(els.selectionSpotlightButton, "click", createSelectionSpotlight);
      on(els.selectionDownloadButton, "click", downloadPng);
    ...
    function handlePanelKeydown(event) {
      ...
      if (!commandKey && !event.altKey && !isTextEntryTarget(event.target)) {
    ...
    function handleShadowPointerDown(event) {
      ...
      if (!els.stampWrap.contains(event.target)) {
        hideStampMenu();
      }
    }
    ...
    function handleToolShortcut(event) {
      ...
      event.preventDefault();
      const shortcut = toolShortcuts[key];

      hideHelpOverlay();
      setActiveTool(shortcut[0]);
      showStatus(`${shortcut[1]} tool`);
      return true;
    }
    ...
    function setActiveTool(tool) {
      if (tool !== "pen" && tool !== "highlighter" && tool !== "eraser" && tool !== "shape" && tool !== "select" && tool !== "text" && tool !== "stamp") {
        return;
      }
    ...
    function setActiveStampType(stampType) {
      if (!isKnownStampType(stampType)) {
        return;
      }
    ...
    function updateToolButtons() {
      ...
      const isStamp = state.activeTool === "stamp";

      els.penButton.classList.toggle("is-active", isPen);
      els.highlighterButton.classList.toggle("is-active", isHighlighter);
      ...
      els.stampButton.classList.toggle("is-active", isStamp);
      els.penButton.setAttribute("aria-pressed", String(isPen));
      els.highlighterButton.setAttribute("aria-pressed", String(isHighlighter));
      ...
      els.stampButton.setAttribute("aria-pressed", String(isStamp));
      els.canvas.classList.toggle("is-eraser", isEraser);
      els.canvas.classList.toggle("is-highlighter", isHighlighter);
      els.canvas.classList.toggle("is-selection", isSelect);
      els.canvas.classList.toggle("is-text", isText);
      els.canvas.classList.toggle("is-stamp", isStamp);
      ...
      els.zoomSelect.value = String(state.viewScale);
    ...
    function updateStampButton() {
      els.stampButton.innerHTML = stampButtonContent(state.activeStampType);
      els.stampButton.title = `Stamp: ${stampDisplayName(state.activeStampType)}`;
      els.stampButton.setAttribute("aria-label", `Stamp tool: ${stampDisplayName(state.activeStampType)}`);

      const stampOptions = els.stampMenu.querySelectorAll("[data-stamp]");

      for (const option of stampOptions) {
        option.classList.toggle("is-selected", option.getAttribute("data-stamp") === state.activeStampType);
      }
    }
    ...
    function updateHistoryButtons() {
      ...
      els.clearButton.disabled = state.operations.length === 0;
    }

    function updateSelectionControls() {
      els.cutButton.disabled = !state.selection;
      els.cropButton.disabled = !state.selection;
      els.calloutButton.disabled = !state.selection;
      els.spotlightButton.disabled = !state.selection;
      ...
      els.downloadButton.title = state.selection ? "Download selected region" : "Download full PNG";
      els.downloadButton.setAttribute("aria-label", state.selection ? "Download selected region as PNG" : "Download full PNG");
    }
    ...
    function handleZoomChange() {
      const nextScale = Number(els.zoomSelect.value);

      if (isAllowedViewScale(nextScale)) {
    ...
    function setViewScale(nextScale) {
      ...
      const viewportCenterX = (els.viewport.scrollLeft + els.viewport.clientWidth / 2) / previousScale;
      const viewportCenterY = (els.viewport.scrollTop + els.viewport.clientHeight / 2) / previousScale;

      commitTextEditor();
      state.viewScale = clamp(nextScale, CONFIG.minViewScale, CONFIG.maxViewScale);
      els.zoomSelect.value = String(state.viewScale);
      updateDocumentSurface();
      updateSelectionOverlay();

      els.viewport.scrollLeft = Math.max(0, viewportCenterX * state.viewScale - els.viewport.clientWidth / 2);
      els.viewport.scrollTop = Math.max(0, viewportCenterY * state.viewScale - els.viewport.clientHeight / 2);
      showStatus(`Zoom ${Math.round(state.viewScale * 100)}%`);
    }
    ...
    function toggleShapeMenu(event) {
      ...
      if (shouldOpen) {
        els.shapeMenu.hidden = false;
        positionMenuForButton(els.shapeMenu, els.shapeButton);
        setActiveTool("shape");
      } else {
        hideShapeMenu();
      }
    ...
    function toggleStampMenu(event) {
      event.preventDefault();
      event.stopPropagation();

      const shouldOpen = els.stampMenu.hidden;

      hideColorMenu();
      hideShapeMenu();
      els.stampButton.setAttribute("aria-expanded", String(shouldOpen));

      if (shouldOpen) {
        els.stampMenu.hidden = false;
        positionMenuForButton(els.stampMenu, els.stampButton);
        setActiveTool("stamp");
      } else {
        hideStampMenu();
      }
    ...
    function hideStampMenu() {
      els.stampMenu.hidden = true;
      els.stampButton.setAttribute("aria-expanded", "false");
    }

    function handleStampMenuClick(event) {
      ...
      setActiveStampType(stampButton.getAttribute("data-stamp"));
      hideStampMenu();
    }
    ...
    function toggleColorMenu(event) {
      ...
      if (shouldOpen) {
        ...
        positionMenuForButton(els.colorMenu, els.colorButton);
      } else {
        hideColorMenu();
      }
    }
    ...
    function toggleHelpOverlay(event) {
      if (event) {
        event.preventDefault();
        event.stopPropagation();
      }
    ...
    function showHelpOverlay() {
      ...
      try {
        els.helpCloseButton.focus({ preventScroll: true });
      } catch (error) {
        els.helpCloseButton.focus();
      }
    }

    function updateHelpOverlayPosition() {
      if (!els || !els.toolbar || !els.helpOverlay) {
        return;
      }

      els.helpOverlay.style.top = `${els.toolbar.offsetHeight + 8}px`;
    }
    ...
    function positionMenuForButton(menu, button) {
      ...
      const gutter = 8;
      const menuWidth = menuRect.width || menu.offsetWidth || 180;
      const menuHeight = menuRect.height || menu.offsetHeight || 160;
      const maxLeft = Math.max(gutter, panelRect.width - menuWidth - gutter);
      const belowTop = buttonRect.bottom - panelRect.top + 6;
      const aboveTop = buttonRect.top - panelRect.top - menuHeight - 6;
      const maxTop = Math.max(gutter, panelRect.height - menuHeight - gutter);
      const shouldOpenAbove = belowTop > maxTop && aboveTop >= gutter;
      const left = clamp(buttonRect.left - panelRect.left, gutter, maxLeft);
      const top = clamp(shouldOpenAbove ? aboveTop : belowTop, gutter, maxTop);

      menu.style.setProperty("--qs-menu-left", `${Math.round(left)}px`);
      menu.style.setProperty("--qs-menu-top", `${Math.round(top)}px`);
    }
    ...
    function beginStroke(event) {
      ...
      state.activeStroke = {
        type: isEraser ? "eraser" : isHighlighter ? "highlight" : "stroke",
        color: state.strokeColor,
        width: isEraser ? state.strokeWidth * 2 : isHighlighter ? Math.max(CONFIG.highlighterMinWidth, state.strokeWidth * CONFIG.highlighterWidthMultiplier) : state.strokeWidth,
        points: [point],
        createdAt: Date.now(),
    ...
    function updateSelectionOverlay(rectOverride, moving) {
      ...
      els.selection.style.left = `${Math.round(rect.x * state.viewScale)}px`;
      els.selection.style.top = `${Math.round(rect.y * state.viewScale)}px`;
      els.selection.style.width = `${Math.round(rect.width * state.viewScale)}px`;
      els.selection.style.height = `${Math.round(rect.height * state.viewScale)}px`;
      els.selection.classList.toggle("is-moving", Boolean(moving));
      updateSelectionActionBar(rect, moving);
    }

    function updateSelectionActionBar(rect, moving) {
      const shouldShow = Boolean(state.selection && rect && !moving && !state.activeSelectionDrag && !state.activeSelectionMove);
      ...
      const surfaceWidth = Math.max(1, state.documentWidth * state.viewScale);
      const surfaceHeight = Math.max(1, state.documentHeight * state.viewScale);
      const selectionLeft = rect.x * state.viewScale;
      const selectionTop = rect.y * state.viewScale;
      const selectionBottom = (rect.y + rect.height) * state.viewScale;

      els.selectionActions.hidden = false;

      const actionsWidth = els.selectionActions.offsetWidth || 300;
      const actionsHeight = els.selectionActions.offsetHeight || 38;
      const x = clamp(selectionLeft, 4, Math.max(4, surfaceWidth - actionsWidth - 4));
      let y = selectionTop - actionsHeight - 6;

      if (y < 4) {
        y = selectionBottom + 6;
      }

      y = clamp(y, 4, Math.max(4, surfaceHeight - actionsHeight - 4));
      els.selectionActions.style.left = `${Math.round(x)}px`;
      els.selectionActions.style.top = `${Math.round(y)}px`;
    }
    ...
    async function cropSelectedRegion() {
      ...
      const rect = { ...state.selection };
      const beforeState = createDocumentStateSnapshot();

      try {
        const croppedCanvas = captureRegionCanvas(rect);
        const blob = await canvasToPngBlob(croppedCanvas);
        const imageRecord = await createImageRecord(blob);

        state.backgroundImage = imageRecord;
        state.operations = [];
        setDocumentSize(imageRecord.width, imageRecord.height);
        clearSelection();

        pushHistory({
          type: "documentSnapshot",
          beforeState,
          afterState: createDocumentStateSnapshot()
        });

        showStatus("Cropped selection");
        scheduleRender();
      } catch (error) {
        console.error("[Quick Sketch] Crop failed.", error);
        showStatus("Crop failed");
      }
    }

    function createSelectionCallout() {
      raisePanel();
      commitTextEditor();
      ...
      try {
        const sourceRect = roundedRect(state.selection);
        const selectedCanvas = captureRegionCanvas(sourceRect);
        const targetRect = computeCalloutTargetRect(sourceRect, selectedCanvas);
        ...
        commitOperation({
          ...
          targetRect,
          color: state.strokeColor,
          width: Math.max(2, state.strokeWidth),
          createdAt: Date.now()
        });

        clearSelection();
        showStatus("Callout added");
      } catch (error) {
        console.error("[Quick Sketch] Callout failed.", error);
        showStatus("Callout failed");
      }
    }

    function createSelectionSpotlight() {
      raisePanel();
      commitTextEditor();
      ...
      try {
        commitOperation({
          type: "spotlight",
          rect: roundedRect(state.selection),
          color: state.strokeColor,
          width: Math.max(2, state.strokeWidth),
          opacity: CONFIG.spotlightOpacity,
          createdAt: Date.now()
        });

        clearSelection();
        showStatus("Spotlight added");
      } catch (error) {
        console.error("[Quick Sketch] Spotlight failed.", error);
        showStatus("Spotlight failed");
      }
    }

    function computeCalloutTargetRect(sourceRect, canvas) {
      const sourceWidth = Math.max(1, canvas.width || sourceRect.width);
      const sourceHeight = Math.max(1, canvas.height || sourceRect.height);
      const scale = Math.min(CONFIG.calloutScale, CONFIG.calloutMaxSide / Math.max(sourceWidth, sourceHeight));
      const width = Math.max(1, Math.round(sourceWidth * scale));
      const height = Math.max(1, Math.round(sourceHeight * scale));
      const gap = CONFIG.calloutGap;
      const candidates = [
        { x: sourceRect.x + sourceRect.width + gap, y: sourceRect.y + sourceRect.height / 2 - height / 2 },
        { x: sourceRect.x - width - gap, y: sourceRect.y + sourceRect.height / 2 - height / 2 },
        { x: sourceRect.x + sourceRect.width / 2 - width / 2, y: sourceRect.y + sourceRect.height + gap },
        { x: sourceRect.x + sourceRect.width / 2 - width / 2, y: sourceRect.y - height - gap }
      ];

      for (const candidate of candidates) {
        if (candidate.x >= 0 && candidate.y >= 0 && candidate.x + width <= state.documentWidth && candidate.y + height <= state.documentHeight) {
          return {
      ...
      return {
        x: Math.round(clamp(candidates[0].x, 0, Math.max(0, state.documentWidth - width))),
        y: Math.round(clamp(candidates[0].y, 0, Math.max(0, state.documentHeight - height))),
        width: Math.min(width, state.documentWidth),
        height: Math.min(height, state.documentHeight)
      };
    }
    ...
    function placeStamp(event) {
      ...
      const point = eventToDocumentPoint(event);
      const stampType = state.activeStampType;
      const stampText = stampType === "number" ? String(state.nextStampNumber) : "";
      ...
      commitOperation({
        ...
        x: point.x,
        y: point.y,
        size: CONFIG.stampSize,
        color: state.strokeColor,
        createdAt: Date.now()
      });

      if (stampType === "number") {
        state.nextStampNumber = state.nextStampNumber >= 9 ? 1 : state.nextStampNumber + 1;
        updateStampButton();
      }

      showStatus(stampType === "number" ? `Stamp ${stampText}` : `${stampDisplayName(stampType)} stamp`);
    }
    ...
    function createTextEditor(x, y) {
      ...
      editor.style.left = `${Math.round(editorX * state.viewScale)}px`;
      editor.style.top = `${Math.round(editorY * state.viewScale)}px`;
      editor.style.width = `${Math.round(CONFIG.textDefaultWidth * state.viewScale)}px`;
      editor.style.height = `${Math.round(CONFIG.textDefaultHeight * state.viewScale)}px`;
      editor.style.minWidth = `${Math.round(180 * state.viewScale)}px`;
      editor.style.minHeight = `${Math.round(82 * state.viewScale)}px`;

      input.className = "qs-text-input";
      input.placeholder = "Type text";
      input.spellcheck = false;
      input.style.setProperty("--qs-text-color", state.strokeColor);
      input.style.fontSize = `${Math.max(12, CONFIG.textFontSize * state.viewScale)}px`;
      input.style.minWidth = `${Math.round(180 * state.viewScale)}px`;
      input.style.minHeight = `${Math.round(54 * state.viewScale)}px`;
    ...
    function clearAnnotations() {
      ...
      const previousOperations = state.operations.slice();
    ...
    function createDocumentStateSnapshot() {
      return {
    ...
    function applyDocumentStateSnapshot(snapshot) {
      state.backgroundImage = snapshot.backgroundImage;
      state.operations = snapshot.operations.slice();
      setDocumentSize(snapshot.documentWidth, snapshot.documentHeight);
      updateHistoryButtons();
    }
    ...
    function applyCommand(command) {
      ...
      if (command.type === "clearAnnotations") {
        state.operations = [];
        updateHistoryButtons();
        return;
      }

      if (command.type === "documentSnapshot") {
        applyDocumentStateSnapshot(command.afterState);
      }
    }
    ...
    function revertCommand(command) {
      ...
      if (command.type === "clearAnnotations") {
        state.operations = command.operations.slice();
        updateHistoryButtons();
        return;
      }

      if (command.type === "documentSnapshot") {
        applyDocumentStateSnapshot(command.beforeState);
      }
    }
    ...
    function updateDocumentSurface() {
      const cssWidth = Math.max(1, Math.round(state.documentWidth * state.viewScale));
      const cssHeight = Math.max(1, Math.round(state.documentHeight * state.viewScale));

      els.surface.style.width = `${cssWidth}px`;
      els.surface.style.height = `${cssHeight}px`;
    ...
    function drawOperation(ctx, operation) {
      ...
      if (operation.type === "eraser") {
        ...
        drawSmoothPath(ctx, operation.points, colorWithAlpha(operation.color, CONFIG.highlighterAlpha), operation.width);
        ...
        ctx.globalCompositeOperation = "source-over";
        drawStampOperation(ctx, operation);
        ...
        ctx.globalCompositeOperation = "source-over";
        drawCalloutOperation(ctx, operation);
      } else if (operation.type === "spotlight") {
        ctx.globalCompositeOperation = "source-over";
        drawSpotlightOperation(ctx, operation);
      } else {
        ctx.globalCompositeOperation = "source-over";
    ...
    function drawStampOperation(ctx, operation) {
      const size = Math.max(18, Number(operation.size) || CONFIG.stampSize);
      const radius = size / 2;
      const x = Number(operation.x) || 0;
      const y = Number(operation.y) || 0;
      const color = normalizeHexColor(operation.color || state.strokeColor);
      ...
      if (operation.stampType === "warning") {
        drawWarningStamp(ctx, x, y, size);
      } else {
        ctx.beginPath();
      ...
      if (operation.stampType === "check") {
        drawCheckStamp(ctx, x, y, size);
      } else if (operation.stampType === "cross") {
        drawCrossStamp(ctx, x, y, size);
      } else if (operation.stampType === "warning") {
        drawWarningBang(ctx, x, y, size);
      } else {
        drawNumberStamp(ctx, operation.stampText || "1", x, y, size);
      }

      ctx.restore();
    }

    function drawNumberStamp(ctx, text, x, y, size) {
      ctx.fillStyle = "#ffffff";
      ctx.textAlign = "center";
      ctx.textBaseline = "middle";
      ctx.font = `800 ${Math.round(size * 0.54)}px Arial, Helvetica, sans-serif`;
      ctx.fillText(String(text).slice(0, 2), x, y + size * 0.02);
    }

    function drawCheckStamp(ctx, x, y, size) {
      ctx.beginPath();
      ctx.moveTo(x - size * 0.24, y + size * 0.02);
      ctx.lineTo(x - size * 0.07, y + size * 0.2);
      ctx.lineTo(x + size * 0.28, y - size * 0.22);
      ctx.stroke();
    }

    function drawCrossStamp(ctx, x, y, size) {
      ctx.beginPath();
    ...
    function drawWarningStamp(ctx, x, y, size) {
      const height = size * 0.9;
      const top = y - height / 2;
      const left = x - size * 0.48;
      const right = x + size * 0.48;
    ...
    function drawWarningBang(ctx, x, y, size) {
      ctx.strokeStyle = "#ffffff";
      ...
      ctx.fillStyle = "#ffffff";
      ctx.beginPath();
      ctx.arc(x, y + size * 0.27, Math.max(1.5, size * 0.055), 0, Math.PI * 2);
      ctx.fill();
    }
    ...
    function drawCalloutOperation(ctx, operation) {
      const source = operation.sourceRect;
      const target = operation.targetRect;

      if (!source || !target || !operation.canvas) {
        return;
      }

      const color = normalizeHexColor(operation.color || state.strokeColor);
      const width = Math.max(2, Number(operation.width) || 2);
      const sourceCenter = rectCenter(source);
      const targetCenter = rectCenter(target);
      const sourceAnchor = rectEdgePoint(source, targetCenter);
      const targetAnchor = rectEdgePoint(target, sourceCenter);
      ...
      ctx.shadowColor = "transparent";
      ctx.drawImage(operation.canvas, target.x, target.y, target.width, target.height);
    ...
    function drawSpotlightOperation(ctx, operation) {
      ...
      const x = clamp(Math.round(rect.x), 0, state.documentWidth);
      const y = clamp(Math.round(rect.y), 0, state.documentHeight);
      const right = clamp(Math.round(rect.x + rect.width), 0, state.documentWidth);
      const bottom = clamp(Math.round(rect.y + rect.height), 0, state.documentHeight);
      ...
      const opacity = clamp(Number(operation.opacity) || CONFIG.spotlightOpacity, 0.1, 0.85);

      ctx.save();
      ctx.fillStyle = `rgba(15, 23, 42, ${opacity})`;
      ctx.fillRect(0, 0, state.documentWidth, y);
      ctx.fillRect(0, bottom, state.documentWidth, state.documentHeight - bottom);
      ctx.fillRect(0, y, x, height);
      ctx.fillRect(right, y, state.documentWidth - right, height);
      ctx.strokeStyle = normalizeHexColor(operation.color || state.strokeColor);
      ctx.lineWidth = Math.max(2, Number(operation.width) || 2);
      ctx.lineJoin = "round";
    ...
    function roundedRect(rect) {
      ...
      return {
        x,
        y,
        width: Math.min(width, Math.max(1, state.documentWidth - x)),
        height: Math.min(height, Math.max(1, state.documentHeight - y))
      };
    }
    ...
    function rectEdgePoint(rect, towardPoint) {
    ...
    async function downloadPng() {
      ...
      try {
        if (state.selection) {
          ...
          fileName = createDownloadFileName("selection");
          statusMessage = "Downloaded selection";
        } else {
          blob = await createExportPngBlob();
    ...
    function createDownloadFileName(scope) {
      const now = new Date();
      ...
      return `quick-sketch-${scopePart}${year}-${month}-${day}-${hours}${minutes}${seconds}.png`;
    }
    ...
    function isAllowedViewScale(value) {
      return value === 0.5 || value === 0.75 || value === 1 || value === 1.5 || value === 2;
    }
    ...
    function isKnownStampType(stampType) {
      return stampType === "number" || stampType === "check" || stampType === "cross" || stampType === "warning";
    }
    ...
    function stampDisplayName(stampType) {
      const map = {
        number: `Number ${state.nextStampNumber}`,
        check: "Check",
        cross: "Cross",
        warning: "Warning"
      };

      return map[stampType] || "Number";
    }

    function stampButtonContent(stampType) {
      if (stampType === "check") {
        return svgIcon("stampCheck");
      }

      if (stampType === "cross") {
        return svgIcon("stampCross");
      }

      if (stampType === "warning") {
        return svgIcon("stampWarning");
      }

      return `<span class="qs-stamp-button-label">${state.nextStampNumber}</span>`;
    }
  ...
  function svgIcon(name) {
    const icons = {
      ...
      highlighter: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 19h8"></path><path d="M7 16 17.5 5.5a2 2 0 0 1 2.8 2.8L9.8 18.8 7 16z"></path><path d="m13.5 9.5 3 3"></path></svg>`,
      ...
      undo: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M9 7H4v5"></path><path d="M4.8 11.2C6.6 7.8 10 6 13.6 6c4 0 7.1 2.8 7.1 6.3 0 3.7-3.4 6.5-7.4 6.5-2.1 0-4.1-.7-5.5-2"></path></svg>`,
      redo: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M15 7h5v5"></path><path d="M19.2 11.2C17.4 7.8 14 6 10.4 6c-4 0-7.1 2.8-7.1 6.3 0 3.7 3.4 6.5 7.4 6.5 2.1 0 4.1-.7 5.5-2"></path></svg>`,
      clear: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 7h12"></path><path d="M9 7V5h6v2"></path><path d="M8 10v8a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-8"></path><path d="M10 12v5"></path><path d="M14 12v5"></path></svg>`,
      ...
      crop: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 3v14h14"></path><path d="M3 7h14v14"></path></svg>`,
      callout: `<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5" width="7" height="6" rx="1"></rect><rect x="13" y="12" width="7" height="7" rx="1"></rect><path d="M10.5 10.5 13.5 13.5"></path><path d="M15.5 15.5h2"></path><path d="M16.5 14.5v2"></path></svg>`,
      spotlight: `<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="7" y="7" width="10" height="10" rx="1"></rect><path d="M4 4h16v16H4z" opacity=".35"></path><path d="M7 12H4"></path><path d="M20 12h-3"></path></svg>`,
      download: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4v10"></path><path d="m8 10 4 4 4-4"></path><path d="M5 20h14"></path></svg>`,
      help: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="8"></circle><path d="M9.8 9a2.4 2.4 0 0 1 4.5 1.2c0 1.8-2.3 2-2.3 3.8"></path><path d="M12 17h.01"></path></svg>`,
      ...
      stampNumber: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="7"></circle><path d="M11 9h1.5v6"></path><path d="M10.5 15h4"></path></svg>`,
      stampCheck: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="7"></circle><path d="m8.5 12.2 2.2 2.2 4.8-5"></path></svg>`,
      stampCross: `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="7"></circle><path d="m9.5 9.5 5 5"></path><path d="m14.5 9.5-5 5"></path></svg>`,
      stampWarning: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5 20 19H4L12 5z"></path><path d="M12 10v4"></path><path d="M12 17h.01"></path></svg>`
    };
