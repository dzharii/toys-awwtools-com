javascript:(function quickSketchBookmarklet() {
  ...
  function createQuickSketchApp(host, shadow) {
    ...
    shadow.innerHTML = `
      <style>
        ...
        *, *::before, *::after {
        ...
        .qs-help-overlay {
          position: absolute;
          inset: ${CONFIG.toolbarHeight + 8}px 10px 10px;
          z-index: 9;
          display: flex;
        ...
        <div id="qsToolbar" class="qs-toolbar">
          ...
          <div class="qs-tool-group" role="toolbar" aria-label="Sketch tools">
            ...
            <div id="qsStampWrap" class="qs-stamp-wrap">
              <button id="qsStampButton" class="qs-button qs-stamp-button qs-tool-button" type="button" title="Stamp: Number 1" aria-label="Stamp tool: Number 1" aria-haspopup="menu" aria-expanded="false" aria-pressed="false"><span id="qsStampButtonLabel" class="qs-stamp-button-label">1</span></button>
    ...
    const els = {
      ...
      stampButtonLabel: shadow.getElementById("qsStampButtonLabel"),
    ...
    function toggleStampMenu(event) {
      ...
      hideColorMenu();
      hideShapeMenu();
      els.stampMenu.hidden = !shouldOpen;
