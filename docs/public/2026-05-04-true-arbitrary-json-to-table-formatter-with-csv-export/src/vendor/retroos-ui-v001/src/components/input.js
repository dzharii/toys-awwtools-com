...
const MIRRORED_ATTRIBUTES = ["value", "placeholder", "disabled", "type", "name", "required", "min", "max", "step", "maxlength", "minlength", "autocomplete", "spellcheck", "list", ...FORM_ARIA_ATTRIBUTES];
