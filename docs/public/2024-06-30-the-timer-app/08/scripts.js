...
const LOCAL_STORAGE_KEY = 'customTimers';

// Load predefined timers
const predefinedTimers = typeof predefinedTimersArray !== 'undefined' ? [...predefinedTimersArray] : [];
...
const saveTimersDebounced = debounce(saveTimers, 500);
...
function renderTimers() {
    ...
    categories.forEach(category => {
        ...
        categoryHeader.setAttribute('aria-label', `Category ${category}`);
        ...
        addTimerButton.addEventListener('click', () => {
            ...
            saveTimersDebounced(storedTimers);
            renderTimers();
        });
