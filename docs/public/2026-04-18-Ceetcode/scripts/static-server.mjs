...
const server = http.createServer((request, response) => {
  ...
  const isWasmBinaryByName = basename === "clang" || basename === "lld" || basename === "memfs";
  response.writeHead(200, {
    "Content-Type": isWasmBinaryByName ? "application/wasm" : contentTypes[ext] || "application/octet-stream",
